#!/bin/bash
# Corrige auto-test.html: remove chinês, traduz para PT-BR, corrige sintaxe e mantém funcional

TARGET="/home/ubuntu/gmp-portal/auto-test.html"
...
cp "$TARGET" "$BACKUP" && echo "🗂️ Backup criado: $BACKUP"

# Substitui o conteúdo por versão revisada
cat > "$TARGET" <<'EOF'
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <title>gmp Portal – Auto Teste</title>
...
<body>
    <div class="test-container">
        <div class="test-header">
            <h1>gmp Portal – Auto Teste do Sistema</h1>
            <p>Validação completa das funcionalidades e desempenho do sistema</p>
        </div>
        ...
        <div class="test-controls">
            ...
            <button id="exportReport" class="test-button">Exportar relatório</button>
        </div>
        ...
        <div id="testConsole" class="test-console">
            <div class="log-line log-info">🚀 Sistema de Auto Teste pronto</div>
    ...
    <script>
        ...
        function exportReport() {
            if (!testRunner || !testRunner.results) {
                console.log('⚠️ Não há resultados para exportar. Execute os testes primeiro.');
                return;
            }
            const report = {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('🌟 Página carregada, sistema pronto');
            console.log('💡 Dica: clique em "Executar teste completo" para iniciar a automação');
        });
    </script>
</body>
</html>
...
echo "✅ auto-test.html corrigido com sucesso."
